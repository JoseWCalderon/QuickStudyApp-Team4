...
namespace QuickStudyApp.ViewModels
{
    public class CalendarViewModel : CalendarModelControls
    {
        ...
        static AssignmentDataInformation databaseDue;
        ...
        public static AssignmentDataInformation DatabaseDue
        {
            get
            {
                if (databaseDue == null)
                {
                    databaseDue = new AssignmentDataInformation(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.LocalApplicationData), "Notes.db3"));
                }
                return databaseDue;
            }
        }
